      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div class="container__inner__right p-8 bg-white rounded shadow-md">
          <form novalidate="novalidate">
            ...
            <div class="relative mb-6 mt-5">
              <a class="primarybutton fw500 ripple mt-5 bg-main-green-600 text-white px-4 py-2 rounded hover:bg-main-green-700 focus:outline-none w-full lg:w-auto" href="{{ route('address.home') }}">Save and Continue</a>
            </div>
          </form>
        </div>
      </div>
