    ...
    h-full z-50 sm:py-0 py-1 flex justify-center items-center backdrop-blur-sm bg-black/25" style="opacity: 1;">
        <div class="sm:w-96 w-full bg-gray-50 rounded-xl text-black shadow-2xl drop-shadow-lg" style="opacity: 1;">
            <header class="modal-header-bg">
                <h3 class="sm:text-black text-gray-50">Login</h3><button class="modal-close"><svg
            ...
            <div class="bg-gray-50 rounded-b-xl px-6 pt-3 pb-8 text-black">
                    ...
                    <div class="my-2">
                        <div class="relative">
                            <input type="tel" autocomplete="tel" name="phone_number"
                                class="common-input input-focus text-sm py-3 rounded-xl"
                                placeholder="Enter Your Phone Number" maxlength="11" value=""
                ...
                <div class="relative flex items-center mb-5">
                    ...
                    <small
                        class="flex-shrink mx-4 font-light text-gray-600">Continue with social login</small>
                    <div class="flex-grow border-t border-pear"></div>
                </div>
                <button
 ...
 c0.001-0.001,0.002-0.001,0.003-0.002l6.19,5.238C36.971,39.205,44,34,44,24C44,22.659,43.862,21.35,43.611,20.083z">
                ...
                <button
                    class="flex py-2 px-4 items-center justify-center space-x-3 border text-sm rounded-xl sm:border-black/50 border-black/10 w-full hover:bg-black hover:text-gray-50 smooth-animate"><svg
                        ...
                        class="text-[#4267B2]" height="26" width="26" xmlns="http://www.w3.org/2000/svg">
                        <g>
  ...
  <section class=" home_appextra ">
    <h2 class=" home_input_title font26 fw700 color111 mb-15"><span class="">Search Nearby <!-- --> </span><span
        class=" content__list__count pl-8" style="transform: translate3d(0px, 0px, 0px);"><span class=""><span class=" color007">Businesses</span></span><span class="">
    ...
    <div style="min-height:1400px" class=" jdcontainer">
      <div id="mainContent" style="scroll-margin:81px" class=" jdwrapper">
        <div class="home_rowbox home_row_1 home_bannerbox mb-50" role="banner" aria-label="slider"
          ...
          <div class="home_banner_li pointer home_banner_swiper font11" tabindex="0" role="button"
            ...
            <div class="slide_show" id="slideshow">
              <ul class="slide_list animate-forward" id="slides">
                <li tabindex="0" class="slide "><span class="slide_anchor" title="IPL" draggable="false"><img
                      draggable="false" title="IPL"
                      src="images/Banners/banner1.jpg"
                      data-src="images/Banners/banner1.jpg"
                      class="home_banner_li_image" alt="IPL"></span></li>
                <li tabindex="0" class="slide "><span class="slide_anchor" title="Ramdan" draggable="false"><img
                      draggable="false" title="Ramdan"
                      src="https://akam.cdn.jdmagicbox.com/images/email_banner/ramadan-entry-point-banner-web-27march.png"
                      data-src="https://akam.cdn.jdmagicbox.com/images/email_banner/ramadan-entry-point-banner-web-27march.png"
                      class="home_banner_li_image" alt="Ramdan"></span></li>
                <li tabindex="0" class="slide "><span class="slide_anchor" title="Hotels in Hyderabad"
                    draggable="false"><img draggable="false" title="Hotels in Hyderabad"
                      src="https://akam.cdn.jdmagicbox.com/images/icontent/newwap/web2022/banner_hotels_2024.webp"
                      data-src="https://akam.cdn.jdmagicbox.com/images/icontent/newwap/web2022/banner_hotels_2024.webp"
                      class="home_banner_li_image" alt="Hotels in Hyderabad"></span></li>
                <li tabindex="0" class="slide "><span class="slide_anchor" title="Earth Movers"
                    draggable="false"><img draggable="false" title="Earth Movers"
                      src="https://akam.cdn.jdmagicbox.com/images/icontent/newwap/web2022/banner_packersmovers_2024.webp"
                      data-src="https://akam.cdn.jdmagicbox.com/images/icontent/newwap/web2022/banner_packersmovers_2024.webp"
                ...
                <li tabindex="0" class="slide prev-slide"><span class="slide_anchor"
                    title="Interior Designer in Hyderabad" draggable="false"><img draggable="false"
                      ...
                      data-src="https://akam.cdn.jdmagicbox.com/images/icontent/newwap/web2022/banner_interiordesigners_2024.webp"
                      class="home_banner_li_image" alt="Interior Designer in Hyderabad"></span></li>
                <li tabindex="0" class="slide active-slide"><span class="slide_anchor" title="CCTV in Hyderabad"
                    draggable="false"><img draggable="false" title="CCTV in Hyderabad"
                      src="https://akam.cdn.jdmagicbox.com/images/icontent/newwap/web2022/banner_cctv_2024.webp"
                      data-src="https://akam.cdn.jdmagicbox.com/images/icontent/newwap/web2022/banner_cctv_2024.webp"
                      class="home_banner_li_image" alt="CCTV in Hyderabad"></span></li>
                <li tabindex="0" class="slide "><span class="slide_anchor" title="Bills in Hyderabad"
                    draggable="false"><img draggable="false" title="Bills in Hyderabad"
                      src="https://akam.cdn.jdmagicbox.com/images/icontent/newwap/web2022/banner_bills_2024.webp"
                      data-src="https://akam.cdn.jdmagicbox.com/images/icontent/newwap/web2022/banner_bills_2024.webp"
                      class="home_banner_li_image" alt="Bills in Hyderabad"></span></li>
                <li tabindex="0" class="slide "><span class="slide_anchor" title="Flights" draggable="false"><img
                      ...
                      data-src="https://akam.cdn.jdmagicbox.com/images/icontent/newwap/web2022/banner_webflight_2024.webp"
          ...
          <a title="JDmart - B2B marketplace"
            href=""
            class="home_banner_li home_banner_li_effect" datatype="#FFF" role="link" aria-label="B2B"
            style="background-color:#0F7DD8">
          ...
          </a><a title="REPAIRS &amp; SERVICES in Hyderabad" href=""
            class="home_banner_li home_banner_li_effect" datatype="#FFF" role="link" aria-label="REPAIRS &amp; SERVICES"
            style="background-color:#2654A1">
          ...
          </a><a title="REAL ESTATE in Hyderabad" href=""
            class="home_banner_li home_banner_li_effect" datatype="#FFF" role="link" aria-label="REAL ESTATE"
            style="background-color:#6769D0">
            ...
            <div class="home_banner_explore" style="background-color: rgb(103, 105, 208);">
              ...
              <noscript>
                  <img
                  alt="REAL ESTATE in Hyderabad" title="REAL ESTATE in Hyderabad" sizes="100vw"
                  srcSet=""
                  src=""
                  decoding="async" data-nimg="fill"
                  style="position:absolute;top:0;left:0;bottom:0;right:0;box-sizing:border-box;padding:0;border:none;margin:auto;display:block;width:0;height:0;min-width:100%;max-width:100%;min-height:100%;max-height:100%"
                  class="home_banner_img_btm" loading="lazy" /></noscript></span>
          </a><a title="DOCTORS in Hyderabad" href=""
            class="home_banner_li home_banner_li_effect" datatype="#FFF" role="link" aria-label="DOCTORS"
            style="background-color:#00ac7d">
            ...
            <div class="home_banner_explore" style="background-color: rgb(0, 172, 125);">
              ...
              style="box-sizing:border-box;display:block;overflow:hidden;width:initial;height:initial;background:none;opacity:1;border:0;margin:0;padding:0;position:absolute;top:0;left:0;bottom:0;right:0">
              <noscript><img
                  alt="DOCTORS in Hyderabad" title="DOCTORS in Hyderabad" sizes="100vw"
                  srcSet=""
                  src=""
                  decoding="async" data-nimg="fill"
                  style="position:absolute;top:0;left:0;bottom:0;right:0;box-sizing:border-box;padding:0;border:none;margin:auto;display:block;width:0;height:0;min-width:100%;max-width:100%;min-height:100%;max-height:100%"
          ...
          <div class="home_hotkeyimg mb-10" style="background-image:url();">
            <span style="box-sizing:border-box;display:inline-block;overflow:hidden;width:initial;height:initial;background:none;opacity:1;border:0;margin:0;padding:0;position:relative;max-width:100%">
              <span style="box-sizing:border-box;display:block;width:initial;height:initial;background:none;opacity:1;border:0;margin:0;padding:0;max-width:100%">
                <img style="display:block;max-width:100%;width:200px;height:auto;background:none;opacity:1;border:0;margin:0;padding:0" alt="" aria-hidden="true" src="data:image/svg+xml,%3csvg%20xmlns=%27http://www.w3.org/2000/svg%27%20version=%271.1%27%20width=%2745%27%20height=%2745%27/%3e">
              </span>
              <img alt="30HP Tractor" title="30HP Tractor" src="images/tractors/tractor1.jpg?w=96&amp;q=75" decoding="async" data-nimg="intrinsic" style="position: absolute; inset: 0px; box-sizing: border-box; padding: 0px; border: none; margin: auto; display: block; width: 200px; height: auto; " srcset="images/tractors/tractor1.jpg?w=48&amp;q=75 1x, images/tractors/tractor1.jpg?w=96&amp;q=75 2x">
              <noscript>
                <img alt="30HP Tractor" title="30HP Tractor" srcSet="images/tractors/tractor1.jpg?w=48&amp;q=75 1x, images/tractors/tractor1.jpg?w=96&amp;q=75 2x" src="images/tractors/tractor1.jpg?w=96&amp;q=75" decoding="async" data-nimg="intrinsic" style="position:absolute;top:0;left:0;bottom:0;right:0;box-sizing:border-box;padding:0;border:none;margin:auto;display:block;width:200px;height:auto;" loading="lazy">
              </noscript>
            </span>
          </div>
        ...
        <a class="home_hotkeybox_li imageZoom text_center " title="20HP" href="#">
          ...
          </a><a class="home_hotkeybox_li imageZoom text_center " title="Home Decor in Hyderabad"
            href="#">
            <div class="home_hotkeyimg mb-10" style="background-image:url();"><span
                style="box-sizing:border-box;display:inline-block;overflow:hidden;width:initial;height:initial;background:none;opacity:1;border:0;margin:0;padding:0;position:relative;max-width:100%"><span
                  style="box-sizing:border-box;display:block;width:initial;height:initial;background:none;opacity:1;border:0;margin:0;padding:0;max-width:100%"><img
          ...
          </a><a href="#" class="home_hotkeybox_li imageZoom text_center Cricket"
            title="Earth Movers">
          ...
          </a><a class="home_hotkeybox_li imageZoom text_center " title="Agriculture Labour"
            href="#">
            <div class="home_hotkeyimg mb-10" style="background-image:url();"><span
                style="box-sizing:border-box;display:inline-block;overflow:hidden;width:initial;height:initial;background:none;opacity:1;border:0;margin:0;padding:0;position:relative;max-width:100%"><span
                  style="box-sizing:border-box;display:block;width:initial;height:initial;background:none;opacity:1;border:0;margin:0;padding:0;max-width:100%"><img
          ...
          </a><a class="home_hotkeybox_li imageZoom text_center " title="Rent &amp; Hire in Hyderabad"
            href="#">
            <div class="home_hotkeyimg mb-10" style="background-image:url();"><span
                style="box-sizing:border-box;display:inline-block;overflow:hidden;width:initial;height:initial;background:none;opacity:1;border:0;margin:0;padding:0;position:relative;max-width:100%"><span
                  style="box-sizing:border-box;display:block;width:initial;height:initial;background:none;opacity:1;border:0;margin:0;padding:0;max-width:100%"><img
          ...
          </a><a class="home_hotkeybox_li imageZoom text_center " title="Hospitals in Hyderabad"
            href="#">
            <div class="home_hotkeyimg mb-10" style="background-image:url();"><span
                style="box-sizing:border-box;display:inline-block;overflow:hidden;width:initial;height:initial;background:none;opacity:1;border:0;margin:0;padding:0;position:relative;max-width:100%"><span
                  style="box-sizing:border-box;display:block;width:initial;height:initial;background:none;opacity:1;border:0;margin:0;padding:0;max-width:100%"><img
          ...
          </a><a class="home_hotkeybox_li imageZoom text_center " title="Contractors in Hyderabad"
            href="#">
            <div class="home_hotkeyimg mb-10" style="background-image:url();"><span
                style="box-sizing:border-box;display:inline-block;overflow:hidden;width:initial;height:initial;background:none;opacity:1;border:0;margin:0;padding:0;position:relative;max-width:100%"><span
                  style="box-sizing:border-box;display:block;width:initial;height:initial;background:none;opacity:1;border:0;margin:0;padding:0;max-width:100%"><img
          ...
          </a><a class="home_hotkeybox_li imageZoom text_center " title="Pet Shops in Hyderabad"
            href="#">
            <div class="home_hotkeyimg mb-10" style="background-image:url();"><span
                style="box-sizing:border-box;display:inline-block;overflow:hidden;width:initial;height:initial;background:none;opacity:1;border:0;margin:0;padding:0;position:relative;max-width:100%"><span
                  style="box-sizing:border-box;display:block;width:initial;height:initial;background:none;opacity:1;border:0;margin:0;padding:0;max-width:100%"><img
        ...
        <div class="home_rowbox home_row_3 home_card_hotkey mb-50" data-tracker-id="cat">
          <div class="cardhotkey__wrap p-30 pt-15 pb-15 pointer"><a href="#"
              class="cat_Wedding Requisites" title="Tractor Implementors">
            ...
            <div class="cardhotkey__content"><a class="cardhotkey__imgBlock text_center mt-10"
                ...
                <div class="cardhotkey_img_outer imageZoom"><span
                    style="box-sizing:border-box;display:inline-block;overflow:hidden;width:initial;height:initial;background:none;opacity:1;border:0;margin:0;padding:0;position:relative;max-width:100%"><span
                      ...
                      src="images/implementors/disc-harrow.jpg?w=640&amp;q=75"
                      decoding="async" data-nimg="intrinsic"
                      style="position: absolute; inset: 0px; box-sizing: border-box; padding: 0px; border: none; margin: auto; display: block; width: 0px; height: 0px; min-width: 100%; max-width: 100%; min-height: 100%; max-height: 100%;"
              ...
              </a><a class="cardhotkey__imgBlock text_center mt-10" title="Cultivator"
                href="#">
                <div class="cardhotkey_img_outer imageZoom"><span
                    style="box-sizing:border-box;display:inline-block;overflow:hidden;width:initial;height:initial;background:none;opacity:1;border:0;margin:0;padding:0;position:relative;max-width:100%"><span
                      style="box-sizing:border-box;display:block;width:initial;height:initial;background:none;opacity:1;border:0;margin:0;padding:0;max-width:100%"><img
                      ...
                      src="images/implementors/cultivator.jpg?w=640&amp;q=75"
                      decoding="async" data-nimg="intrinsic"
                      style="position: absolute; inset: 0px; box-sizing: border-box; padding: 0px; border: none; margin: auto; display: block; width: 0px; height: 0px; min-width: 100%; max-width: 100%; min-height: 100%; max-height: 100%;"
              ...
              </a><a class="cardhotkey__imgBlock text_center mt-10" title="Caterers in Hyderabad"
                href="#">
                <div class="cardhotkey_img_outer imageZoom"><span
                    style="box-sizing:border-box;display:inline-block;overflow:hidden;width:initial;height:initial;background:none;opacity:1;border:0;margin:0;padding:0;position:relative;max-width:100%"><span
                      style="box-sizing:border-box;display:block;width:initial;height:initial;background:none;opacity:1;border:0;margin:0;padding:0;max-width:100%"><img
                      ...
                      src="images/implementors/boom-sprayer.png?w=640&amp;q=75"
                      decoding="async" data-nimg="intrinsic"
                      style="position: absolute; inset: 0px; box-sizing: border-box; padding: 0px; border: none; margin: auto; display: block; width: 0px; height: 0px; min-width: 100%; max-width: 100%; min-height: 100%; max-height: 100%;"
            ...
            <div class="cardhotkey__content"><a class="cardhotkey__imgBlock text_center mt-10"
                ...
                <div class="cardhotkey_img_outer imageZoom"><span
                    style="box-sizing:border-box;display:inline-block;overflow:hidden;width:initial;height:initial;background:none;opacity:1;border:0;margin:0;padding:0;position:relative;max-width:100%"><span
                      ...
                      src="images/man_power/farming_women.jpg?w=640&amp;q=75"
                      decoding="async" data-nimg="intrinsic"
                      style="position: absolute; inset: 0px; box-sizing: border-box; padding: 0px; border: none; margin: auto; display: block; width: 0px; height: 0px; min-width: 100%; max-width: 100%; min-height: 100%; max-height: 100%;"
              ...
              </a><a class="cardhotkey__imgBlock text_center mt-10" title="Chilli Picker"
                href="#">
                <div class="cardhotkey_img_outer imageZoom"><span
                    style="box-sizing:border-box;display:inline-block;overflow:hidden;width:initial;height:initial;background:none;opacity:1;border:0;margin:0;padding:0;position:relative;max-width:100%"><span
                      style="box-sizing:border-box;display:block;width:initial;height:initial;background:none;opacity:1;border:0;margin:0;padding:0;max-width:100%"><img
                      ...
                      src="images/man_power/chilli_picker.jpg?w=640&amp;q=75"
                      decoding="async" data-nimg="intrinsic"
                      style="position: absolute; inset: 0px; box-sizing: border-box; padding: 0px; border: none; margin: auto; display: block; width: 0px; height: 0px; min-width: 100%; max-width: 100%; min-height: 100%; max-height: 100%;"
              ...
              </a><a class="cardhotkey__imgBlock text_center mt-10" title="Sack pickers"
                href="#">
                <div class="cardhotkey_img_outer imageZoom"><span
                    style="box-sizing:border-box;display:inline-block;overflow:hidden;width:initial;height:initial;background:none;opacity:1;border:0;margin:0;padding:0;position:relative;max-width:100%"><span
                      style="box-sizing:border-box;display:block;width:initial;height:initial;background:none;opacity:1;border:0;margin:0;padding:0;max-width:100%"><img
                      ...
                      src="images/man_power/sack_picker.jpg?w=640&amp;q=75"
                      decoding="async" data-nimg="intrinsic"
                      style="position: absolute; inset: 0px; box-sizing: border-box; padding: 0px; border: none; margin: auto; display: block; width: 0px; height: 0px; min-width: 100%; max-width: 100%; min-height: 100%; max-height: 100%;"
          ...
          <div class="cardhotkey__wrap p-30 pt-15 pb-15 pointer"><a href="#"
              class="cat_Repairs &amp; Services" title="Repairs &amp; Services in Hyderabad">
            ...
            <div class="cardhotkey__content"><a class="cardhotkey__imgBlock text_center mt-10"
                ...
                <div class="cardhotkey_img_outer imageZoom"><span
                    style="box-sizing:border-box;display:inline-block;overflow:hidden;width:initial;height:initial;background:none;opacity:1;border:0;margin:0;padding:0;position:relative;max-width:100%"><span
                      ...
                      src="images/mechanics/pump_repairing_service.png?w=640&amp;q=75"
                      decoding="async" data-nimg="intrinsic"
                      style="position: absolute; inset: 0px; box-sizing: border-box; padding: 0px; border: none; margin: auto; display: block; width: 0px; height: 0px; min-width: 100%; max-width: 100%; min-height: 100%; max-height: 100%;"
              ...
              </a><a class="cardhotkey__imgBlock text_center mt-10" title="Pump Set mechanic (Diesel engine)"
                href="#">
                <div class="cardhotkey_img_outer imageZoom"><span
                    style="box-sizing:border-box;display:inline-block;overflow:hidden;width:initial;height:initial;background:none;opacity:1;border:0;margin:0;padding:0;position:relative;max-width:100%"><span
                      style="box-sizing:border-box;display:block;width:initial;height:initial;background:none;opacity:1;border:0;margin:0;padding:0;max-width:100%"><img
                      ...
                      src="images/mechanics/diesel_engine_pump_set.png?w=640&amp;q=75"
                      decoding="async" data-nimg="intrinsic"
                      style="position: absolute; inset: 0px; box-sizing: border-box; padding: 0px; border: none; margin: auto; display: block; width: 0px; height: 0px; min-width: 100%; max-width: 100%; min-height: 100%; max-height: 100%;"
              ...
              </a><a class="cardhotkey__imgBlock text_center mt-10" title="Solar pump set mechanic"
                href="#">
                <div class="cardhotkey_img_outer imageZoom"><span
                    style="box-sizing:border-box;display:inline-block;overflow:hidden;width:initial;height:initial;background:none;opacity:1;border:0;margin:0;padding:0;position:relative;max-width:100%"><span
                      style="box-sizing:border-box;display:block;width:initial;height:initial;background:none;opacity:1;border:0;margin:0;padding:0;max-width:100%"><img
                      ...
                      src="images/mechanics/solar_pump.png?w=640&amp;q=75"
                      decoding="async" data-nimg="intrinsic"
                      style="position: absolute; inset: 0px; box-sizing: border-box; padding: 0px; border: none; margin: auto; display: block; width: 0px; height: 0px; min-width: 100%; max-width: 100%; min-height: 100%; max-height: 100%;"
          ...
          <div class="cardhotkey__wrap p-30 pt-15 pb-15 pointer"><a href="#"
              class="cat_Daily Needs" title="Sprayers">
              <h2 class="cardhotkey__title fw500 font18 color111">Sprayers</h2>
            </a>
            <div class="cardhotkey__content"><a class="cardhotkey__imgBlock text_center mt-10" href="#"
                title="sprayer">
                <div class="cardhotkey_img_outer imageZoom"><span
                    style="box-sizing:border-box;display:inline-block;overflow:hidden;width:initial;height:initial;background:none;opacity:1;border:0;margin:0;padding:0;position:relative;max-width:100%"><span
                      style="box-sizing:border-box;display:block;width:initial;height:initial;background:none;opacity:1;border:0;margin:0;padding:0;max-width:100%"><img
                      ...
                      src="images/man_power/sprayer.jpg?w=640&amp;q=75"
                      decoding="async" data-nimg="intrinsic"
                      style="position: absolute; inset: 0px; box-sizing: border-box; padding: 0px; border: none; margin: auto; display: block; width: 0px; height: 0px; min-width: 100%; max-width: 100%; min-height: 100%; max-height: 100%;"
              ...
              </a><a class="cardhotkey__imgBlock text_center mt-10" title="Battery Sprayer"
                href="#">
                <div class="cardhotkey_img_outer imageZoom"><span
                    style="box-sizing:border-box;display:inline-block;overflow:hidden;width:initial;height:initial;background:none;opacity:1;border:0;margin:0;padding:0;position:relative;max-width:100%"><span
                      style="box-sizing:border-box;display:block;width:initial;height:initial;background:none;opacity:1;border:0;margin:0;padding:0;max-width:100%"><img
                      ...
                      src="images/man_power/battery_sprayer.jpg?w=640&amp;q=75"
                      decoding="async" data-nimg="intrinsic"
                      style="position: absolute; inset: 0px; box-sizing: border-box; padding: 0px; border: none; margin: auto; display: block; width: 0px; height: 0px; min-width: 100%; max-width: 100%; min-height: 100%; max-height: 100%;"
              ...
              </a><a class="cardhotkey__imgBlock text_center mt-10" title="Fuel Sparyer"
                href="#">
                <div class="cardhotkey_img_outer imageZoom"><span
                    style="box-sizing:border-box;display:inline-block;overflow:hidden;width:initial;height:initial;background:none;opacity:1;border:0;margin:0;padding:0;position:relative;max-width:100%"><span
                      style="box-sizing:border-box;display:block;width:initial;height:initial;background:none;opacity:1;border:0;margin:0;padding:0;max-width:100%"><img
                      ...
                      src="images/man_power/fuel_sprayer.jpg?w=640&amp;q=75"
                      decoding="async" data-nimg="intrinsic"
                      style="position: absolute; inset: 0px; box-sizing: border-box; padding: 0px; border: none; margin: auto; display: block; width: 0px; height: 0px; min-width: 100%; max-width: 100%; min-height: 100%; max-height: 100%;"
          ...
          <div class=" jdwrapper jddtl_slider ">
            ...
            <div class=" jddtl_slider_box">
              <div tabindex="0" class=" jddtl_slide popularsearches_slide">
                <div class=" popularsearches_slide_imgbox">
                  <div class=" popularsearches_slide_imginner"><img tabindex="-1"
                      src="images/implementors/implementor-banner.jpg" alt="Implementors"
                      title="Implementors" class=" popularsearches_slide_image"></div>
                </div>
              ...
              <div tabindex="0" class=" jddtl_slide popularsearches_slide">
                <div class=" popularsearches_slide_imgbox">
                  <div class=" popularsearches_slide_imginner"><img tabindex="-1"
                      src="images/mechanics/tractor_mechanic.jpg"
                      alt="Repair &amp; Service photo" title="Get Quote for Repair &amp; Service"
              ...
              <div tabindex="0" class=" jddtl_slide popularsearches_slide">
                <div class=" popularsearches_slide_imgbox">
                  <div class=" popularsearches_slide_imginner"><img tabindex="-1"
                      src="images/tractors/jcb1.png"
                      alt="Earth Movers photo" title="Get Quote for Earth Movers"
                      class=" popularsearches_slide_image"></div>
                </div>
                <div class=" popularsearches_txtbox">
                  <div class=" popularsearches_category line_clamp_2 font18 fw500 colorFFF">
              ...
              <div tabindex="0" class=" jddtl_slide popularsearches_slide">
                <div class=" popularsearches_slide_imgbox">
                  <div class=" popularsearches_slide_imginner"><img tabindex="-1"
                      src="images/man_power/farm_worker.jpg" alt="Farm Workers photo"
                      title="Get Quote for Farm Workers" class=" popularsearches_slide_image"></div>
                </div>
                <div class=" popularsearches_txtbox">
                  <div class=" popularsearches_category line_clamp_2 font18 fw500 colorFFF">
              ...
              <div tabindex="0" class=" jddtl_slide popularsearches_slide">
                <div class=" popularsearches_slide_imgbox">
                  <div class=" popularsearches_slide_imginner"><img tabindex="-1"
                      src="images/machine/farm-drones.jpg" alt="Drones photo"
                      title="Get Quote for Drones" class=" popularsearches_slide_image">
                  </div>
                </div>
                <div class=" popularsearches_txtbox">
                  <div class=" popularsearches_category line_clamp_2 font18 fw500 colorFFF">
      ...
      <div class="row">
        <div class="col-md-4 my-4 my-md-0">
          ...
          <div class="card position-relative">
            <a href="#"><img src="images/tractors/tractor1.jpg" class="img-fluid rounded-4"
                alt="image"></a>
