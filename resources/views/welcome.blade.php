  ...
  <div style="min-height:1400px" class=" jdcontainer">
    <div id="mainContent" style="scroll-margin:81px" class=" jdwrapper">
      <div class="home_rowbox home_row_1 home_bannerbox mb-50" role="banner" aria-label="slider"
        ...
        <div class="home_banner_li pointer home_banner_swiper font11" tabindex="0" role="button" fdprocessedid="w05rkp">
      ...
      <div class="hotkeyele-wrap">
        <div>
          <div>
            <div class="type11imgwrp"><a href="#" aria-label="freelisting_banner"><img class="lazify type11img"
                  src="images/Banners/banner5.jpg" alt="Banner" style="height: 100%;"></a></div>
    ...
    @endforeach
          ...
          <div class="home_hotkeyimg mb-10" style="background-image:url();"><span
              style="box-sizing:border-box;display:inline-block;overflow:hidden;width:initial;height:initial;background:none;opacity:1;border:0;margin:0;padding:0;position:relative;max-width:100%"><span
                style="box-sizing:border-box;display:block;width:initial;height:initial;background:none;opacity:1;border:0;margin:0;padding:0;max-width:100%"><img
                  ...
                  alt="" aria-hidden="true"
                  src="data:image/svg+xml,%3csvg%20xmlns=%27http://www.w3.org/2000/svg%27%20version=%271.1%27%20width=%2745%27%20height=%2745%27/%3e"></span><img
                alt="Machines" title="Machines" src="images/tractors/tractor65.png?w=96&amp;q=75" decoding="async"
                data-nimg="intrinsic"
                style="position: absolute; inset: 0px; box-sizing: border-box; padding: 0px; border: none; margin: auto; display: block; width: 200px; height: auto;"
          ...
          <div class="home_hotkeyimg mb-10" style="background-image:url();"><span
              style="box-sizing:border-box;display:inline-block;overflow:hidden;width:initial;height:initial;background:none;opacity:1;border:0;margin:0;padding:0;position:relative;max-width:100%"><span
                style="box-sizing:border-box;display:block;width:initial;height:initial;background:none;opacity:1;border:0;margin:0;padding:0;max-width:100%"><img
                  ...
                  alt="" aria-hidden="true"
                  src="data:image/svg+xml,%3csvg%20xmlns=%27http://www.w3.org/2000/svg%27%20version=%271.1%27%20width=%2745%27%20height=%2745%27/%3e"></span><img
                alt="Implementors" title="Implementors" src="images/implementors/cultivator.jpg?w=96&amp;q=75"
                decoding="async" data-nimg="intrinsic"
                style="position: absolute; inset: 0px; box-sizing: border-box; padding: 0px; border: none; margin: auto; display: block; width: 200px; height: auto;"
          ...
          <div class="home_hotkeyimg mb-10" style="background-image:url();"><span
              style="box-sizing:border-box;display:inline-block;overflow:hidden;width:initial;height:initial;background:none;opacity:1;border:0;margin:0;padding:0;position:relative;max-width:100%"><span
                style="box-sizing:border-box;display:block;width:initial;height:initial;background:none;opacity:1;border:0;margin:0;padding:0;max-width:100%"><img
                  ...
                  alt="" aria-hidden="true"
                  src="data:image/svg+xml,%3csvg%20xmlns=%27http://www.w3.org/2000/svg%27%20version=%271.1%27%20width=%2745%27%20height=%2745%27/%3e"></span><img
                alt="Hospitals in Hyderabad" title="Hospitals in Hyderabad" src="images/dronesprayer.png?w=96&amp;q=75"
                decoding="async" data-nimg="intrinsic"
                style="position: absolute; inset: 0px; box-sizing: border-box; padding: 0px; border: none; margin: auto; display: block; width: 0px; height: 0px; min-width: 100%; max-width: 100%; min-height: 100%; max-height: 100%;"
      ...
      <div data-tracker-id="web_PopularCatagory_impression" class=" home_rowbox home_row_9 home_popularsearches mb-50">
            ...
            <div tabindex="0" class=" jddtl_slide popularsearches_slide">
              ...
              <div class=" popularsearches_txtbox">
                <div class=" popularsearches_category line_clamp_2 font18 fw500 colorFFF">
                  ...
                  class=" popularsearches_button whitefill_animate font16 fw600 color007" fdprocessedid="b7c39k">Enquire
                  Now</button>
              </div>
            </div>
            <div tabindex="0" class=" jddtl_slide popularsearches_slide">
              ...
              <div class=" popularsearches_txtbox">
                <div class=" popularsearches_category line_clamp_2 font18 fw500 colorFFF">
                  ...
                  class=" popularsearches_button whitefill_animate font16 fw600 color007" fdprocessedid="cydfli">Enquire
                  Now</button>
              </div>
            </div>
            ...
            <div tabindex="0" class=" jddtl_slide popularsearches_slide">
              ...
              <div class=" popularsearches_txtbox">
                <div class=" popularsearches_category line_clamp_2 font18 fw500 colorFFF">
                  ...
                  class=" popularsearches_button whitefill_animate font16 fw600 color007" fdprocessedid="ehk6vp">Enquire
                  Now</button>
              </div>
            </div>
            <div tabindex="0" class=" jddtl_slide popularsearches_slide">
              ...
              <div class=" popularsearches_txtbox">
                <div class=" popularsearches_category line_clamp_2 font18 fw500 colorFFF">
                  ...
                  class=" popularsearches_button whitefill_animate font16 fw600 color007" fdprocessedid="k9jdyp">Enquire
                  Now</button>
              </div>
            </div>
          </div>
      ...
      <div class="mobile-view-section">
        <div>
          <div class="mb-30">
            <div>
              <div class="flex_spacebetween mb-15 font15 fw600 pd15 color36">News near you<i class="next-arrow"></i>
              </div>
              <div class="pd15 home_cur_list"><a
                  href="#"
                  title="City of Joy to City of Dreams: 5 Best Bengali Restaurants Explore"
                  aria-label="City of Joy to City of Dreams: 5 Best Bengali Restaurants Explore">
                  <div class="home_cur_listli">
                    <div class="home_cur_img"><img
                        src=""
                        alt="" title=""></div>
                    <div class="home_cur_txtotr">
                      <div class="font11 home_cur_txt1">Lorem ipsum is placeholder text commonly used in the graphic, print, and publishing industries for previewing layouts and visual mockups.</div>
                      <div class="font11 mt-15 home_cur_txt2">Explore</div>
                    </div>
                  </div>
                </a><a
                  href="#"
                  title="Let Your Creativity Shine at These Interesting Art Cafes in Delhi Explore"
                  ...
                  href="#"
                  title="Get a Makeover at any of these Celebrity Frequented Beauty Parlours Explore"
                  aria-label="Get a Makeover at any of these Celebrity Frequented Beauty Parlours Explore">
                  <div class="home_cur_listli">
                    <div class="home_cur_img"><img
                        src=""
                        alt="" title=""></div>
                  ...
                  href="#"
                  title="Amp Up Your Engagement Ceremony with These 11 Precious and Semi Precious Jewellery Brands in India Explore"
                  aria-label="Amp Up Your Engagement Ceremony with These 11 Precious and Semi Precious Jewellery Brands in India Explore">
                  <div class="home_cur_listli">
                    <div class="home_cur_img"><img
                        src=""
                        alt="" title=""></div>
                  ...
                  href="#"
                  title="Nurturing Tech Enthusiasts: Exploring Best Institutes for BCA Explore"
                  aria-label="Nurturing Tech Enthusiasts: Exploring Best Institutes for BCA Explore">
                  <div class="home_cur_listli">
                    <div class="home_cur_img"><img
                        src=""
                        alt="" title=""></div>
                    <div class="home_cur_txtotr">
                      <div class="font11 home_cur_txt1">Lorem ipsum is placeholder text commonly used in the graphic, print, and publishing industries for previewing layouts and visual mockups.
                      </div>
                      <div class="font11 mt-15 home_cur_txt2">Explore</div>
                    </div>
                  </div>
                  ...
                  href="#"
                  title="Engineer's Day: Celebrating the Innovations and Creativity of the Universal Problem Solvers Explore"
                  aria-label="Engineer's Day: Celebrating the Innovations and Creativity of the Universal Problem Solvers Explore">
                  <div class="home_cur_listli">
                    <div class="home_cur_img"><img
                        src=""
                        alt="" title=""></div>
                  ...
                  href="#"
                  title="Comprehensive Guide to the Best Cancer Centres Explore"
                  aria-label="Comprehensive Guide to the Best Cancer Centres Explore">
                  <div class="home_cur_listli">
                    <div class="home_cur_img"><img
                        src=""
                        alt="" title=""></div>
                  ...
                  href="#"
                  title="Leading the Fight: Top Cancer Hospitals in India Pioneering Advanced Care Explore"
                  aria-label="Leading the Fight: Top Cancer Hospitals in India Pioneering Advanced Care Explore">
                  <div class="home_cur_listli">
                    <div class="home_cur_img"><img
                        src=""
                        alt="" title=""></div>
                  ...
                  href="#"
                  title="Calling All Bibliophiles to Curl Up with a Book at These 12 Cosy Book Cafes Explore"
                  aria-label="Calling All Bibliophiles to Curl Up with a Book at These 12 Cosy Book Cafes Explore">
                  <div class="home_cur_listli">
                    <div class="home_cur_img"><img
                        src=""
                        alt="" title=""></div>
                    <div class="home_cur_txtotr">
                      <div class="font11 home_cur_txt1">Calling All Bibliophiles to Curl Up with a Book at These 12 Cosy
                        Book Cafes</div>
                      <div class="font11 mt-15 home_cur_txt2">Explore</div>
                    </div>
                  </div>
                  ...
                  href="#"
                  title="National Reading Day 2024: Top Bookstores in India to Explore the World of Rabindranath Tagore Explore"
                  aria-label="National Reading Day 2024: Top Bookstores in India to Explore the World of Rabindranath Tagore Explore">
                  <div class="home_cur_listli">
                    <div class="home_cur_img"><img
                        src=""
                        alt="" title=""></div>
