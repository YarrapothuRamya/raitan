...
<div class="md:section-container md:py-6 mt-20">
    <div class="flex md:gap-6">
        <div class="md:flex hidden flex-col border rounded-xl overflow-hidden w-96 shadow-md h-fit">
            ...
            <div><a href="/account/profile/">
                    <div
                        class="hover:bg-pear/20 px-3 smooth-animate flex items-center border-b border-opacity-50 text-gray-700 border-gray-400 py-3 space-x-2 text-sm">
                        <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 1024 1024"
                            class="w-5 h-5 opacity-70" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                            <path
            ...
            <div style="opacity: 1;">
                <section aria-describedby="List of Bookings Page">
                    <div class="relative select-none">
                        <div
                            class=" flex overflow-x-auto overflow-y-hidden hide-scrollbar will-change-transform transition-all duration-300 cursor-grabbing relative flex w-full border rounded-xl justify-between sm:gap-8 gap-2 sm:snap-none snap-x">
                            <a class="text-black border-pistachio w-full py-3  border-b-2  smooth-animate
      hover:text-pistachio flex items-center gap-2 justify-center" role="button" href="#"><span>On Going</span></a><a
                                class="text-gray-500  border-transparent w-full py-3  border-b-2  smooth-animate
      hover:text-pistachio flex items-center gap-2 justify-center" role="button" href="#"><span>Upcoming</span></a><a
                                class="text-gray-500  border-transparent w-full py-3  border-b-2  smooth-animate
      hover:text-pistachio flex items-center gap-2 justify-center" role="button"
                                href="/account/booking/?view=completed"><span>Completed</span></a>
                        </div>
                    </div>
                    <div class="p-2">
                        <div class="mx-auto w-full flex flex-col   py-4">
                            <div
                                class="tractor-block border border-pear/30 shadow-md shadow-pear/30 rounded-lg lg:p-4 p-2">
                                <div class="flex justify-between clickable">
                                            ...
                                            <div class="flex mt-1 text-sm items-center flex-wrap text-gray-500 mb-1">
                                                <div class="flex mt-2 mb-1">
                                                    ...
                                                    <svg stroke="currentColor" fill="currentColor" stroke-width="0"
                                                        viewBox="0 0 512 512"
                                                        class="mt-1 mr-1 text-pistachio min-w-[24px]" height="24"
                                                    ...
                                                    <div class="text-sm"><span class="block"> Bachupally, K V Rangareddy
                                                            District</span><span class="block text-xs">Hyderabad -
                                                            500090</span>
                                                            <span class="block mt-2">Booking ID: 12345</span>
                                                         <span class="block ">Booking Date: 2024-07-07 </span>
                                    ...
                                    <div class="ml-4 flex flex-col items-stretch justify-between">
                                        <div class="flex justify-center"><button id="book-now-btn"
                                                class="action-btn py-1.5 font-light text-sm w-full px-4 inline-block mt-2 rounded-lg text-center shadow-md"
                                                fdprocessedid="6ebs2">View Details</button></div>
                                    </div>
                                </div>
                            </div>
