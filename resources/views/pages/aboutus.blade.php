...
<section class=" home_appextra "  style="justify-content: center;">
        ...
        <a href="#" class="rounded-md action-btn px-3.5 py-2.5 text-sm font-semibold  shadow-sm  focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 ">Our values <span aria-hidden="true">&rarr;</span></a>
        <a href="#" class="rounded-md action-btn px-3.5 py-2.5 text-sm font-semibold  shadow-sm  focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 ">Meet our leadership <span aria-hidden="true">&rarr;</span></a>
