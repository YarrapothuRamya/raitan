...
<nav class="bg-grey-light w-full rounded-md" style="margin-top: 5rem; padding-left: 5rem;">
  <ol class="list-reset flex">
    ...
    <li class="text-neutral-400">Earthmovers</li>
  </ol>
</nav>
      ...
      <div class="text-sm">
        ...
        <div class="relative select-none">
          <div class="flex overflow-x-auto overflow-y-hidden hide-scrollbar will-change-transform transition-all duration-300 cursor-grabbing relative flex rounded-full mt-4 mb-2 border sm:snap-none snap-x">
            <button id="filter-chain" class="text-sm py-2 px-4 whitespace-nowrap text-pistachio rounded-full w-full smooth-animate">Chain</button>
            <button id="filter-tyre" class="hover:bg-gray-200 text-sm py-2 px-4 whitespace-nowrap text-pistachio rounded-full w-full smooth-animate">Tyre</button>
...
<script>
  document.addEventListener('DOMContentLoaded', function () {
    const filterButtons = {
      'chain': document.getElementById('filter-chain'),
    ...
    filterButtons['chain'].addEventListener('click', () => filterTractors('chain'));
    filterButtons['tyre'].addEventListener('click', () => filterTractors('tyre'));
