                ...
                <div>
                        ...
                        <ul class="mt-3">
                            <li class="flex items-center">
                                <div
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" fill='#50b500'
                    ...
                    <div class="mt-12">
                        ...
                        <ul class="flex mt-3 space-x-4">
                            ...
                            <li class="bg-[#e6e6e6cf] h-10 w-10 rounded-full flex items-center justify-center shrink-0">
                                <a href="javascript:void(0)">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" fill='#50b500' viewBox="0 0 50 50">
<path d="M 11 4 C 7.134 4 4 7.134 4 11 L 4 39 C 4 42.866 7.134 46 11 46 L 39 46 C 42.866 46 46 42.866 46 39 L 46 11 C 46 7.134 42.866 4 39 4 L 11 4 z M 13.085938 13 L 21.023438 13 L 26.660156 21.009766 L 33.5 13 L 36 13 L 27.789062 22.613281 L 37.914062 37 L 29.978516 37 L 23.4375 27.707031 L 15.5 37 L 13 37 L 22.308594 26.103516 L 13.085938 13 z M 16.914062 15 L 31.021484 35 L 34.085938 35 L 19.978516 15 L 16.914062 15 z"></path>
                            ...
                            <li class="bg-[#e6e6e6cf] h-10 w-10 rounded-full flex items-center justify-center shrink-0">
                                <a href="javascript:void(0)">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" fill="#50b500" viewBox="0 0 24 24">
    <path d="M23.835 7.294c-.213-.801-.828-1.416-1.629-1.629C20.713 5 12 5 12 5s-8.713 0-10.206.665c-.801.213-1.416.828-1.629 1.629C0 8.787 0 12 0 12s0 3.213.165 4.706c.213.801.828 1.416 1.629 1.629C3.287 19 12 19 12 19s8.713 0 10.206-.665c.801-.213 1.416-.828 1.629-1.629C24 15.213 24 12 24 12s0-3.213-.165-4.706zM9.5 15.25V8.75l6.5 3.75-6.5 3.75z"/>
</svg>
                                </a>
                            </li>
                        </ul>
                ...
                <form action="" method="post" class="ml-auo space-y-4">
                    <input type='text' name="name" placeholder='Name'
                        class="common-input input-focus w-full rounded-md py-2.5 px-4 text-sm " />
                    <input type='email' name='email' placeholder='Email'
                        class="common-input input-focus w-full rounded-md py-2.5 px-4 text-sm " />
                    <input type='text' placeholder='Subject' name='subject'
                        class="common-input input-focus w-full rounded-md py-2.5 px-4 text-sm " />
                    <textarea placeholder='Message' rows="6" name='message'
                        class="common-input input-focus w-full rounded-md px-4 text-sm pt-2.5 "></textarea>
                    <button type='button' type="submit"
                        class="action-btn w-full py-2 rounded-xl mt-2 flex items-center justify-center space-x-2">Send</button>
                </form>
            </div>
        </div>
