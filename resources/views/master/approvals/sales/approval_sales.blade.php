    ...
    <div class="w-full overflow-hidden rounded-lg shadow-xs">
        <div class="bg-white shadow-md rounded-lg">
            <div class="bg-gray-200 px-6 py-4 rounded-t-lg flex justify-between items-center">
                <h2 class="text-gray-800 font-semibold text-lg">Sales Approvals</h2>
            </div>
                ...
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-md-6 text-md-end">
                            <button type="button" class="btn btn-primary machineadd"  data-toggle="modal" data-target="#roleModal">Add Machinary</button>
                        </div>
                    </div>
                </div>
