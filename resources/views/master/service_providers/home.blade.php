            ...
            <div class="w-full overflow-x-auto">
                ...
                <table class="w-full divide-y divide-gray-200" id="repair_service">
                    ...
                    <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                        <?php $i = 0; ?>
                        <?php
                        foreach ($business_contacts1 as $business_contacts) {
                            $user_id = $business_contacts->user_id;
                            $customer = App\Models\Customer::where('id', $user_id)->orderBy('id', 'DESC')->get();
                            $count =   App\Models\Business_contact::where('user_id', $user_id)->count();
                        ?>
