...
<div class="mt-4 mx-4">
    ...
    <div class="w-full overflow-hidden rounded-lg shadow-md">
        ...
        <div class="w-full overflow-x-auto">
            ...
            <input type="text" id="searchInput" onkeyup="filterTable()" placeholder="Search for machinery..." class="px-4 py-2   bg-gray-50 dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-md">
        </div>
            <table class="w-full divide-y divide-gray-200" id="machineTable">
                <thead>
