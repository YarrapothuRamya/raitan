...
<div class="min-h-screen flex items-center justify-center bg-gray-100 p-4">
    <form action="{{ route('implementor.add') }}" method="post" enctype="multipart/form-data" class="w-full max-w-lg bg-white p-8 rounded-lg shadow-lg">
        @csrf
        <div id="show_message" class="mb-4"></div>

        <h2 class="text-2xl font-bold mb-6 text-center">Add Implementor</h2>
